...
module.exports.getweeklymostliked = function (dd, callback) {
    var td = new Date(); 
var nextSunday= new Date(td.getFullYear(),td.getMonth(),td.getDate()+(7-td.getDay()))
var prevsunday= new Date(td.getFullYear(),td.getMonth(),td.getDate()+(0-td.getDay()))
    //console.log(nextSunday+" "+prevsunday)
    const query = {
        $and: [{ status: "accepted" }, {
            date: {
                $gte: prevsunday,
